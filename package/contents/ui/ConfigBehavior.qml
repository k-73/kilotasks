...
Item {
    ...
    Kirigami.FormLayout {
        ...
        ComboBox {
            ...
            Layout.fillWidth: true
            Layout.minimumWidth: Kirigami.Units.gridUnit * 14
            model: [i18n("Do not group (each window a separate icon)"), i18n("By program name")]
        }

        ComboBox {
            id: groupedTaskVisualization
            Kirigami.FormData.label: i18n("Click grouped task:")
            Layout.fillWidth: true
            Layout.minimumWidth: Kirigami.Units.gridUnit * 14
            ...
            model: [
                ...
                i18n("Show tooltips"),
                i18n("Show Present Windows effect"),
                i18n("Show textual list")
            ]
        }
        ...
        RowLayout {
            ...
            CheckBox {
                ...
                text: i18n("Only group when the widget is full")
                enabled: groupingStrategy.currentIndex > 0
            }
        }
        ...
        CheckBox {
            ...
            text: i18n("Keep pinned launchers on the left of running tasks")
        }
