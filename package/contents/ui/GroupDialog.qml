...
PlasmaCore.Dialog {
    ...
    function findActiveTaskIndex() {
        ...
        for (let i = 0; i < groupListView.count; i++) {
            if (tasksModel.makeModelIndex(visualParent.taskIdx, i) === tasksModel.activeTask) {
    ...
    mainItem: MouseHandler {
        ...
        function moveRow(event, insertAt) {
            ...
            const parentModelIndex = tasksModel.makeModelIndex(groupDialog.visualParent.taskIdx);
        ...
        PlasmaComponents3.ScrollView {
            ...
            ListView {
                ...
                model: DelegateModel {
                    ...
                    model: tasksModel
                    rootIndex: tasksModel.makeModelIndex(groupDialog.visualParent.taskIdx)
                    delegate: Task {
